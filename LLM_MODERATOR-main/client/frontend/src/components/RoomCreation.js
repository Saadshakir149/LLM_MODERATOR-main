        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          ...
          <div className="glass-card p-6 md:p-8 shadow-2xl border border-white/50 animate-slide-up [animation-delay:200ms]">
            ...
            <div className="space-y-6">
              ...
              {/* Moderator Toggle */}
              <div className="p-4 bg-gradient-to-r from-indigo-50/50 to-purple-50/50 border border-indigo-50 rounded-2xl">
              ...
              <div className="space-y-6 pt-4 border-t border-slate-100">
                <button
                  ...
                  className="w-full btn-primary py-3.5 flex items-center justify-center gap-2 shadow-md shadow-indigo-100"
                >
                ...
                <div className="relative py-2">
                  ...
                  <div className="relative flex justify-center text-xs">
                    <span className="px-3 bg-white text-slate-450 uppercase font-bold tracking-wider">Or Join Existing Room</span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-4 py-2.5 bg-white border border-slate-200 rounded-xl outline-none focus:border-indigo-400 focus:ring-4 focus:ring-indigo-100/50 transition duration-200 text-sm"
                      disabled={loading}
                    />
                    <button
                      onClick={(e) => joinRoom(e)}
                      disabled={loading || !userName.trim() || !roomId.trim()}
                      className="px-6 py-2.5 bg-slate-800 text-white rounded-xl hover:bg-slate-900 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center gap-2 font-semibold text-sm whitespace-nowrap shadow-sm"
                    >
                      <MdLogin size={16} />
                  ...
                  {!userName.trim() && roomId.trim() && (
                    <p className="text-[11px] text-red-500 font-semibold mt-2.5 flex items-center gap-1.5 animate-fade-in">
                      <span className="w-1.5 h-1.5 bg-red-500 rounded-full"></span>
                      Please input your display name first
                    </p>
                  )}
                  {userName.trim() && !roomId.trim() && (
                    <p className="text-[11px] text-slate-400 font-medium mt-2.5 flex items-center gap-1.5">
                      <span className="w-1.5 h-1.5 bg-slate-305 rounded-full"></span>
                      Paste code above to join workspace
                    </p>
                  )}
                  {userName.trim() && roomId.trim() && (
                    <p className="text-[11px] text-emerald-600 font-semibold mt-2.5 flex items-center gap-1.5 animate-fade-in">
